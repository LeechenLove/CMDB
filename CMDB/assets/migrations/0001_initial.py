# Generated by Django 2.2 on 2020-07-02 22:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '存储设备'), ('securitydevice', '安全设备'), ('software', '软件资产')], default=0, verbose_name='设备状态')),
                ...
                ('expire_day', models.DateTimeField(blank=True, null=True, verbose_name='过保日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.TextField(verbose_name='资产数据')),
                ('c_time', models.DateTimeField(auto_now_add=True, verbose_name='汇报日期')),
                ('m_time', models.DateTimeField(auto_now=True, verbose_name='数据更新时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(help_text='例如：RedHat release 7', max_length=64, unique=True, verbose_name='软件/系统版本')),
            ],
            options={
                'verbose_name': '软件/系统',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpy_core_count', models.PositiveSmallIntegerField(default=1, verbose_name='CPU核数')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': 'CPU',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slot', models.IntegerField(verbose_name='插槽')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mac', models.CharField(max_length=128, verbose_name='MAC地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capacity', models.FloatField(blank=True, null=True, verbose_name='磁盘容量')),
                ('interface_typ', models.CharField(choices=[('SATA', 'SATA'), ('SAS', 'SAS'), ('SCSI', 'SCSI'), ('SSD', 'SSD'), ('unknown', 'unknown')], default='unknown', max_length=16, verbose_name='接口类型')),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '硬盘',
