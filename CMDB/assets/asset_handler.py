...
class ApproveAsset(object):
    ...
    def _create_nic(self, asset):
        ...
        for nic_dict in nic_list:
            ...
            net_mask = nic_dict.get('net_mask')
            if net_mask:
                if len(net_mask) > 0:
                    nic.net_mask = net_mask[0]
            nic.save()
...
class UpdateAsset(object):
    ...
    def _server_update(self):
        try:
            ...
            log('update_failed', msg=e, asset=self.asset)
            print(e)
            return False
        ...
        if new_disks_dict:
            for key in new_disks_dict:
                ...
                defaults = {
                    ...
                    'capacity': new_disks_dict[key].get('capacity'),
